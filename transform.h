...
public:
    ...
    Transform operator*(Transform &rhs) {
        ...
        for (int x = 0; x < 4; x += 1) {
            for (int y = 0; y < 4; y += 1) {
                r.matrix[x][y] = (matrix[x][0] * rhs.matrix[0][y]) + (matrix[x][1] * rhs.matrix[1][y]) +
                                 (matrix[x][2] * rhs.matrix[2][y]) + (matrix[x][3] * rhs.matrix[3][y]);
            }
        }
    ...
    Transform inverse() {
        ...
        float det = this->matrix[0][0] * r.matrix[0][0] + this->matrix[0][1] * r.matrix[1][0] +
                    this->matrix[0][2] * r.matrix[2][0] + this->matrix[0][3] * r.matrix[3][0];
